...
import { Users, Plus, Trash2, X, Check, Upload, ImageOff, Pencil, MessageSquare, Linkedin, Mail, Github } from 'lucide-react';
...
function makeDraftFrom(existing: Trainer | null): DraftTrainer {
  return {
    name: existing?.name || '',
    bio: existing?.bio || '',
    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-eqc-muted mt-1">Click any trainer tile to edit name, photo, bio, quote and socials.</p>
        </div>
...
function TrainerEditorModal({
  ...
  const initial = useMemo(() => makeDraftFrom(trainer), [trainer]);
